...
public class SampleSeat {
    ...
    public static final String DEFAULT_BUSINESS_SEAT_NUMBER = "BU124";

    public static final Seat SAMPLE_BUSINESS_SEAT = Seat.createBusinessClass(DEFAULT_BUSINESS_SEAT_NUMBER);
